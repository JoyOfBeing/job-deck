...
function JobReportSlide() {
  ...
  return (
    <div className="slide job-report-slide">
      <h3>13 · JOB Report · Interactive</h3>
...
const slides = [
  ...
  () => (
    <div className="slide">
      <h3>12 · RCO Membership Economy</h3>
  ...
  () => (
    <div className="slide">
      <h3>16 · New Human Resources · The Wedge</h3>
